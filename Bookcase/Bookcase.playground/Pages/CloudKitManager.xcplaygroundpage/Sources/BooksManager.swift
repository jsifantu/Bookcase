...
public class BooksManager {
  ...
  public func removeBook(at index:Int) {
  ...
  public func updateBook(at index:Int, with book:Book) {
    if searchFilter.isEmpty {
      books[index] = book
      sort(books:&books)
    } else {
  ...
  public func addBookCloudKit(book:Book, completion: @escaping (_ error:CKError?)->Void) {
  ...
  public func updateBookCloudKit(at index:Int, with book:Book, completion: @escaping (_ error:Error?)->Void) {
    db.save(book.record) { (record, error) in
      DispatchQueue.main.async {
        if let error = error as? CKError {
          //Error occurred
  ...
  public func deleteBookCloudKit(at index:Int, book:Book, completion: @escaping (_ error:Error?)->Void) {
